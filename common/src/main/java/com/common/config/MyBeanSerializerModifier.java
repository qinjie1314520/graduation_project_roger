...
public class MyBeanSerializerModifier extends BeanSerializerModifier {
    ...
    public List<BeanPropertyWriter> changeProperties(SerializationConfig config,
        ...
        for (int i = 0; i < beanProperties.size(); i++) {
            ...
            }else if(isIntegerAndLongType(writer)){
    ...
    /**
     * 功能描述: 判断该次序列化的对象是不是Integer或者Long，如果是返则回true
     * @param writer BeanPropertyWriter
     * @return boolean
     */
    protected boolean isIntegerAndLongType(BeanPropertyWriter writer) {
        Class<?> clazz = writer.getType().getRawClass();
        return clazz.equals(Integer.class) || clazz.equals(int.class) || clazz.equals(Long.class) || clazz.equals(long.class) || clazz.equals(Double.class) || clazz.equals(double.class);
    }
}
